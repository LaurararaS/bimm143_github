...
My favorite candy is Hershey’s Kisses, and the winpercent value is
55.37545.
...
This depends on checking mean or median for center. Mean is above 50%,
median is lower than 50%.
...
On average, chocolate candy (60.92153) is higher ranked than fruit candy
(44.11974).
...
The difference is statistically significant. We have a p-value of
2.871e-08, which is a lot smaller than 0.05. We have enough evidence to
support that there is a significant difference between chocolate and
fruity candy’s winpercent.
...
Based on the graph, Reese’s Miniatures seem to be highly popular and
affordable.
...
The five most expensive candies are listed above. Among them, Nik L Nip
is the least popular (with a winpercent of around 22)
...
orignial variables to the new PCs.
...
Interactive plots than can be zoomed on and “brushed” over can be made
